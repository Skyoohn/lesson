...
public interface TorihikisakiMainMapper {
	...
	@Select("select * from sampledb.torihikisaki_main where torihikisaki_id=#{torihikiID}")
	TorihikisakiMain selectTorihikisakiMain(Integer ID);
	
	@Insert("insert into sampledb.torihikisaki_main(TORIHIKI_NAME_ALL,TORIHIKI_NAME_RYAKU,YUUBIN,JYUSYO_1)values(#{torihikiNameAll},#{torihikiNameRyaku},#{yuubin},#{jyusyo1})")
	void addTorihikisakiMain(TorihikisakiMain torihikisakiMain);
	
	@Update("update sampledb.torihikisaki_main set TORIHIKI_NAME ALL=#{torihikiNameALL},TORIHIKI_NAME_RYAKU=#{torihikiNameRyaku},YUUBIN=#{yuubin},JYUSYO_1=#{jyusyo1} where TORIHIKI_ID=#{torihikiId}")
	void updateTorihikisakiMain(TorihikisakiMain torihikisakiMain);
	
	@Delete("delete sampledb.from torihikisaki_main where TORIHIKI_ID=#{torihikiId}")
     ...
     * @mbg.generated Mon Dec 18 16:49:45 KST 2023
     */
    int deleteByPrimaryKey(Long torihikiId);
     ...
     * @mbg.generated Mon Dec 18 16:49:45 KST 2023
     */
    TorihikisakiMain selectByPrimaryKey(Long torihikiId);
