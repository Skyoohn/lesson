...
public interface TorihikisakiMainMapper {
	...
	@Update("update sampledb.torihikisaki_main set TORIHIKI_NAME_ALL=#{torihikiNameALL},TORIHIKI_NAME_RYAKU=#{torihikiNameRyaku},YUUBIN=#{yuubin},JYUSYO_1=#{jyusyo1} where TORIHIKI_ID=#{torihikiId}")
